$(document).ready(function(){
	...
	// =============================================================
	// Remove Success and Error Messages after some time ------start
	// =============================================================

	var $errorClass = $(".messages li").hasClass("error");
	var $successClass = $(".messages li").hasClass("success");
	var $warningClass = $(".messages li").hasClass("warning");

	if ($errorClass){
		setInterval(function(){
			$(".messages").fadeOut('slow').fadeIn('slow');
		}, 1000);
	}else if(($successClass) || ($warningClass)){
		setTimeout(function(){
	...
	// =============================================================
	// Remove Success and Error Messages after some time ------Ends
	// =============================================================
